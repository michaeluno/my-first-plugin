...
abstract class MyFirstPlugin_AdminPageFramework_Factory_Controller extends MyFirstPlugin_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aMyFirstPlugin_AdminPageFramework']['aFieldErrors'] = $this->oUtil->getElement($GLOBALS, array('aMyFirstPlugin_AdminPageFramework', 'aFieldErrors'), array());
    ...
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aMyFirstPlugin_AdminPageFramework']['aNotices'] = $this->oUtil->getElement($GLOBALS, array('aMyFirstPlugin_AdminPageFramework', 'aNotices'), array());
    ...
    public function hasSettingNotice($sType = '') {
        $_aNotices = $this->oUtil->getElementAsArray($GLOBALS, array('aMyFirstPlugin_AdminPageFramework', 'aNotices'), array());
        if (!$sType) {
