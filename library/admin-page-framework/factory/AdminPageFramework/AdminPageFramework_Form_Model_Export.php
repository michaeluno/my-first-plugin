 ...
 */
abstract class MyFirstPlugin_AdminPageFramework_Form_Model_Export extends MyFirstPlugin_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new MyFirstPlugin_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
