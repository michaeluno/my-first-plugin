 ...
 */
abstract class MyFirstPlugin_AdminPageFramework_Form_Model_Import extends MyFirstPlugin_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new MyFirstPlugin_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
