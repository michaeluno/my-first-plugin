...
final class MyFirstPlugin_AdminPageFramework_Registry extends MyFirstPlugin_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['MyFirstPlugin_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['MyFirstPlugin_AdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('MyFirstPlugin_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class MyFirstPlugin_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        ...
        new MyFirstPlugin_AdminPageFramework_RegisterClasses(empty(MyFirstPlugin_AdminPageFramework_Registry::$aClassFiles) ? MyFirstPlugin_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('MyFirstPlugin_AdminPageFramework_MinifiedVersionHeader', 'MyFirstPlugin_AdminPageFramework_BeautifiedVersionHeader',),), MyFirstPlugin_AdminPageFramework_Registry::$aClassFiles);
        MyFirstPlugin_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('MyFirstPlugin_AdminPageFramework_InclusionClassFilesHeader');
    }
